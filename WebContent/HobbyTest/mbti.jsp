          ...
          <li class="slider-item active">
            <div class="grid vertical">
              <div class="column-xs-12 column-md-2 hide-mobile">
                <div class="intro">
                  <a href="#">
                    <h1><a class="m_title" href="https://www.16personalities.com/ko"><span class="underline">MBTI</span></h1>
                  </a>
                </div>
              </div>
              <div class="column-xs-12 column-md-10">
                ...
                <div class="grid">
                  <div class="column-xs-12 column-md-9">
                    ...
                    <p class="m_title"><input type="text" placeholder="성격유형 입력" name="mbti"><input type="submit" value="검색"></p>
